...
object Versions {
    ...
    const val androidx_test_espresso_espresso_core: String = "3.1.1" 

    const val androidx_test_runner: String = "1.1.1" 

    const val com_airbnb_android: String = "3.4.1" 

    const val com_android_support_test_espresso_espresso_core: String = "3.0.2" 

    const val com_android_support_test_runner: String = "1.0.2" 

    const val aapt2: String = "3.5.0-alpha11-5342889" 

    const val com_android_tools_build_gradle: String = "3.5.0-alpha11" 

    const val lint_gradle: String = "26.5.0-alpha11" 
    ...
    const val adapter_rxjava2: String = "2.5.0" 

    const val converter_moshi: String = "2.5.0"
