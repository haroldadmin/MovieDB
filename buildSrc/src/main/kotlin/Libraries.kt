object Libraries {
    ...
    const val agp = "com.android.tools.build:gradle:${BuildConfig.agp}"
    const val kotlinGradlePlugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:${BuildConfig.kotlin}"
    const val googleServices = "com.google.gms:google-services:${BuildConfig.googleServices}"
    const val safeArgs = "androidx.navigation:navigation-safe-args-gradle-plugin:${Versions.navigation}"
    const val fabricToolsGradle = "io.fabric.tools:gradle:${BuildConfig.fabricTools}"
    ...
    const val legacyPreferenceV14 = "androidx.legacy:legacy-preference-v14:${Versions.legacyPreferenceV14}"
    ...
    const val cnrAdapter = "com.github.haroldadmin:CoroutinesNetworkResponseAdapter:${Versions.cnrAdapter}"
